...
class MobileViT_dynamicFPN(nn.Module):
    def __init__(self, image_size, mode, num_classes, patch_size=(32, 32)):  
        super().__init__()
        ih, iw = image_size
        self.ph, self.pw = patch_size
        ...
        # Convolutions initiales
        self.conv_0 = nn.Conv2d(1, channels[0], kernel_size=3, stride=2, padding=1)
...
# model = MobileViT_dynamicFPN(image_size=(4096, 1024), mode='xx_small', num_classes=1000)
