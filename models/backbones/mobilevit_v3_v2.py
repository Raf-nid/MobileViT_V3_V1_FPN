...
class MobileViTv3_v2(nn.Module):
    def __init__(self, image_size, width_multiplier, num_classes, patch_size=(32,32)):  
        """
...
class MobileViTv3_v2_dynamicFPN(nn.Module):
    def __init__(self, image_size, width_multiplier, num_classes, patch_size=(32,32)):  
        """
        Implementation of MobileViTv3 based on v2
        """
...
#model = MobileViTv3_v2_dynamicFPN(image_size=(4096, 64), width_multiplier=0.5, num_classes=1000, patch_size=(16,16))
