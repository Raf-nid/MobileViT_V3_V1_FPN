...
class MobileViTv3_v1_dynamicFPNpixel(nn.Module):
    def __init__(self, image_size, mode, num_classes, patch_size=(64, 64)):  
        ...
        self.ph, self.pw = patch_size
        assert ih % self.ph == 0 and iw % self.pw == 0 
        assert mode in ['xx_small', 'xx_small4', 'x_small', 'small']
...
if __name__ == "__main__":
    ...
    model = MobileViTv3_v1_dynamicFPNpixel((4096, 1024), 'xx_small', 1000, (32, 32))
