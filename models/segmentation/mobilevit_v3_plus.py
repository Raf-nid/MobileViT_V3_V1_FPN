...
class MobileViTv3_v1_dynamicFPN_plus(nn.Module):
...
#    model = MobileViTv3_v1_dynamicFPN_plus((4096, 1024), 'xx_small', 1000, (32, 32))
...
#
#    model = MobileViTv3_v1_dynamicFPN_plus((4096, 1024), 'x_small', 1000, (32, 32))
#
#    # === fvcore ===
#    print("=== [fvcore] ===")
#
